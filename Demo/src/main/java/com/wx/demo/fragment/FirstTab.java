...
public class FirstTab extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.layout_first_fragment, null);
        root = TreeNode.root();
        ...
        containerView = (ViewGroup) layout.findViewById(R.id.tree_container);
        containerView.addView(tView.getView());

        Button refreshBtn = (Button) layout.findViewById(R.id.btn_refresh_tree);
    ...
    private void fillFolder(TreeNode folder, List<DataDetail> children) {
        for (int i = 0; i < children.size(); i++) {
            ...
            node.setViewHolder(new TreeNodeHolder(getActivity()));
    ...
    private void addRootNode(List<DataDetail> list) {
        if (root != null) {
            for (DataDetail detail : list) {
                ...
                s1.setViewHolder(new TreeNodeHolder(getActivity()));
